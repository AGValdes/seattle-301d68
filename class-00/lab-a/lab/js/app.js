...
function displayPics() {
  ...
  // It threw an error because of how variables declared with const are scoped. The variable rando only has a value declared within the scope of the while loop it is contained in.
  console.log(viewed);
